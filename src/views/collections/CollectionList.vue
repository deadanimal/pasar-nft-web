<template>
    ...
    <div data-component="view.collections.CollectionList">
        ...
        <collection-list-menu></collection-list-menu>
...
<script>
    ...
    import CollectionListMenu from '@/components/collections/collection-list/CollectionListMenu.vue'
