<template>
	...
	<div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5" data-component="components.collections.my-collection.form.CoverPhoto">
		...
		<div class="mt-1 sm:mt-0 sm:col-span-2">
			...
			<div class="max-w-lg flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md h-36" :class="{ 'hidden': !formState.showingPreview, 'block': formState.showingPreview }" :style="photoPreviewStyle">
			</div>
